...
<template>
  <div v-if="clients" class="flex flex-col flex-nowrap h-full gap-y-4">
    <div class="flex justify-between me-10">
      <p class="text-2xl font-semibold">العملاء</p>
      <PartnersAdd type="عميل" @close="refresh" />
    </div>
    ...
    >
      <template #label-data="{ row }">
        <NuxtLink
          :to="{ name: 'clients-prt', params: { prt: row.id } }"
